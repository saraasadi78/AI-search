...
void BFS::Result(Node *node, vector<Node> &nodes_vector)
{
	cout << "Found A Solution! Check out the Resultbfs.txt file." << endl;
	stack<Node*> nodes_stack;
	ofstream myfile;
	myfile.open("Resultbfs.txt");
